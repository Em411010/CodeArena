...
const Login = () => {
  ...
  useEffect(() => {
    ...
    else if (error === 'facebook_auth_failed') toast.error('Facebook sign-in failed. Please try again.');
    else if (error) toast.error('OAuth sign-in failed. Please try again.');
  }, [searchParams]);
      ...
      <div className="card bg-base-300 shadow-xl w-full max-w-md">
        <div className="card-body">
          <div className="text-center mb-4">
            ...
            <p className="text-base-content/70 mt-2">Sign in to continue to CodeArena</p>
          </div>
