...
import { FileCode, Plus, Loader2, Edit, Trash2 } from 'lucide-react';
          ...
          <table className="w-full">
            <thead className="bg-arena-dark">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-400 uppercase hidden sm:table-cell">Difficulty</th>
